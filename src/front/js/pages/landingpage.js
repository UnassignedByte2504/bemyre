...
export const LandingPage = () =>{
    ...
    return(
        <div>
            <LandingJumbo />
            <h2 className="text-white container mt-5">Conciertos en Sevilla esta semana <i class="far fa-calendar-alt"></i>{day}/{month} - <i class="far fa-calendar-alt"></i>{day+7}/{month}</h2>
