  ...
  return {
    ...
    actions: {
      ...
      signUp: async (username, email, password, firstname, lastname) => {
        ...
        await fetch(
          "https://3001-unassignedbyte25-bemyre-8sdg6lwipsv.ws-eu80.gitpod.io/api/signup",
          options
        )
      ...
      login: async (email, password) => {
        await fetch(
          "https://3001-unassignedbyte25-bemyre-8sdg6lwipsv.ws-eu80.gitpod.io/api/login",
          {
            method: "POST",
            headers: {
      ...
      fetchUser: async (username) => {
        await fetch(
          "https://3001-unassignedbyte25-bemyre-8sdg6lwipsv.ws-eu80.gitpod.io/api/pablo",
          {
            method: "GET",
            headers: {
