...
export const Spain = () => {
  ...
  useEffect(() => {
    actions.setProvincia(provincia);
  }, [provincia]);
  return (
    <Box className="MapWrapper">
      <Box className="SpainTitle">
        <Typography variant="h2">Seleccionar Provincia</Typography>
      </Box>
      <Box className="mapa">
        <svg
          className="svg"
        ...
        >
          ...
          <Tooltip TransitionComponent={Zoom} arrow followCursor={true} title="Valladolid">
            <path
