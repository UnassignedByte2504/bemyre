...
Revision ID: 45f61de7af5b
Revises: 
Create Date: 2022-12-23 13:31:46.992457
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_musician_info', sa.Integer(), nullable=False),
    sa.Column('music_genre_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['music_genre_id'], ['music_genre.id'], ),
    sa.ForeignKeyConstraint(['user_musician_info'], ['user_musician_info.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
